const words = ["Nicolas.", "a designer.", "a researcher.", "an infovore.", "a UX writer."]

let cursor = gsap.to('.cursor', 1.25, {opacity:0, ease: "power2.inOut", repeat:-1})
let masterTl = gsap.timeline({repeat: -1}).pause()
let boxTl = gsap.timeline()

boxTl.to('.box', {duration:1, width:"17.5vw", delay: 0.5, ease: "power4.inOut"})
